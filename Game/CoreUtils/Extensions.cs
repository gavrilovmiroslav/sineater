...
internal static class Extensions
{
    ...
    {
        batch.DrawString(font, text, new Vector2(x, y), fg ?? Color.White, 0.0f, Vector2.Zero, 1.0f, SpriteEffects.None, 0);
    }

    public static void DrawTextCenter(this SpriteBatch batch, int x, int y, SpriteFont font, string text, Color? fg = null, float rot = 0)
    {
        var origin = font.MeasureString(text) / 2;
        batch.DrawString(font, text, new Vector2(x, y), fg ?? Color.White, rot, origin, 1.0f, SpriteEffects.None, 0);
    }
