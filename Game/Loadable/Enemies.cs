...
public class EnemyParser : ILoadableRowParser<EnemyDefinition>
{
    ...
    private const int POISE = 3;
    private const int CLARITY = 4;
    private const int WILL = 5;
    private const int VIGOR = 6;
    private const int NIGHT_SPEED_UP = 7;
    private const int DAY_SPEED_UP = 8;
    private const int NIGHT_GUARD_UP = 9;
    private const int DAY_GUARD_UP = 10;
    private const int TAGS = 11;
