...
{
    public class LDTKRender : IDisposable
    {
        ...
        public LDTKRender(SpriteBatch spriteBatch)
        {
        ...
        /// <summary> Initializes a new instance of the <see cref="LDTKRender"/> class. This is used to intizialize the renderer for use with content Pipeline. </summary>
        /// <param name="spriteBatch">SpriteBatch</param>
        /// <param name="content">Optional ContentManager</param>
        public LDTKRender(SpriteBatch spriteBatch, ContentManager content)
            : this(spriteBatch)
        {
        ...
        public void RenderLevel(Vector2 position, LDtkLevel level, Vector2? scale = null)
        {
            ...
            {
                SpriteBatch.Draw(layers[i], level.Position.ToVector2() + position, null, Color.White, 0,
