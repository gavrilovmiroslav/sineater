...
public static class ItemLibrary
{
    ...
    public static readonly Weapon Dagger = new Weapon("Dagger", 2, EWeightClass.Light, 5, (2, 5), null, [ new SkirmishStep_AttackFront(1) ], critOn: 4);
    public static readonly Weapon Scepter = new Weapon("Scepter", 4, EWeightClass.Heavy, 3, (3, 5), null, [ new SkirmishStep_AttackFront(1) ]);
    public static readonly Weapon WizardStaff = new Weapon("Wizard Staff", 2, EWeightClass.Heavy, 1, (5, 5), null, [ new SkirmishStep_AttackFront(1) ]);
    ...
    public static readonly Weapon Claymore = new Weapon("Claymore", 4, EWeightClass.Large, 4, (1, 8), null, [
        ...
        new SkirmishStep_AttackFront(1),
    ], openingsPerCrit: 2, vigScaling: EScalingFactor.S, poiScaling: EScalingFactor.A);
    ...
    public static readonly Weapon ThornWhip = new Weapon("Thorn Whip", 1, EWeightClass.Heavy, 5, (4, 8), null, [ 
        new SkirmishStep_AttackFront(1),
