...
public static class ItemLibrary
{
    ...
    public static readonly Weapon BrokenSword = new Weapon("Sword of Old", 2, EWeightClass.Medium, 6, (3, 0));
    ...
    public static readonly Weapon ScrollTome = new Weapon("Scroll Tome", 1, EWeightClass.Heavy, 7, (2, 2));
    ...
    public static readonly Armor Tunic = new Armor("Tunic", 3, EWeightClass.Medium, 2, (0, 1));
    ...
    public static readonly Armor Robe = new Armor("Robe", 2, EWeightClass.Medium, 4, (5, 1));
