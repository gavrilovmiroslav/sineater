...
public class Builder : ContentBuilder
{
    public override IContentCollection GetContentCollection()
    {
        ...
        contentCollection.IncludeCopy<WildcardRule>("audio\\Desktop\\*");
        contentCollection.IncludeCopy<WildcardRule>("*txt");
        contentCollection.IncludeCopy<WildcardRule>("*json");
        contentCollection.IncludeCopy<WildcardRule>("*ldtkl");
        contentCollection.IncludeCopy<WildcardRule>("*ldtk");
        contentCollection.IncludeCopy<WildcardRule>("*yaml");
        contentCollection.IncludeCopy<WildcardRule>("*.xp");
        contentCollection.IncludeCopy<WildcardRule>("*world_map_tiles_SUMMER.png");

        contentCollection.Exclude<WildcardRule>("audio\\sineater\\*");
        contentCollection.Exclude<WildcardRule>("map\\backups\\*");
        contentCollection.Exclude<WildcardRule>("*svg");
        contentCollection.Exclude<WildcardRule>("*ttf");
        contentCollection.Exclude<WildcardRule>("*otf");
        contentCollection.Exclude<WildcardRule>("*pdn");
        contentCollection.Exclude<WildcardRule>("*File.spritefont");
